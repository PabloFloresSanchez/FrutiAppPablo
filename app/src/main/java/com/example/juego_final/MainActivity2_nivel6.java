...
public class MainActivity2_nivel6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_sign = (ImageView)findViewById(R.id.imageView_signo);
    ...
    public void RandomNum(){
        if(score <= 70){
            ...
            if (randomNum_one >= 0 && randomNum_one <= 3){
                result = randomNum_one + randomNum_two;
                iv_sign.setImageResource(R.drawable.adicion);
            } else if (randomNum_one >= 4 && randomNum_one <= 7){
                result = randomNum_one - randomNum_two;
                iv_sign.setImageResource(R.drawable.resta);
            } else {
                result = randomNum_one * randomNum_two;
                iv_sign.setImageResource(R.drawable.multiplicacion);
            }
